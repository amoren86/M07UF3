...
public class HibernateConfig {
	...
	public LocalSessionFactoryBean sessionFactory(DataSource dataSource) {
		...
		sessionFactory.setPackagesToScan("cat.institutmarianao.user", "cat.institutmarianao.question",
				"cat.institutmarianao.answer", "cat.institutmarianao.vote", "cat.institutmarianao.rank");
